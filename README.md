...
> **🎯 NEW: Auto-Sort Feature!** Automatically sort tracks into phases based on BPM/audio analysis. See [AUTO_SORT_GUIDE.md](documentation/AUTO_SORT_GUIDE.md)
>
> **👉 New to the system?** See [MANUAL_STEPS.md](documentation/MANUAL_STEPS.md) for a clear guide on what YOU need to do vs what's automated.

### ▶️ Quick Start (Yarn/NPM)

```bash
# 1. Complete setup (venv + dependencies + permissions)
yarn setup
...
- `yarn status` - Show system status
- `yarn run help` - Show all commands

See [YARN_COMMANDS.md](documentation/YARN_COMMANDS.md) for complete reference.

### ▶️ Manual Setup (Python)
